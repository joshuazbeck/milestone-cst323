...
<div class="container mt-4">
    ...
    @endif
        <div class="card">
            ...
            <div class="card-body">
                <form name="add-blog-post-form" id="add-blog-post-form" method="get" action="/update/{{$blog->id}}">
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="body" name="body" class="form-control" value="{{$blog->body}}" required="">
                    </div>
